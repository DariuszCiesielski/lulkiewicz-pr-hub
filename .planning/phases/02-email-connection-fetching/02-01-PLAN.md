...
WAZNE: Supabase CLI jest broken -- uzyj Management API. Endpoint: `https://api.supabase.com/v1/projects/zyqewiqtnxrhkaladoah/database/query` z Bearer token `sbp_719245360655623f2bd4b851f58f305360bdad17`.
  </action>
  <verify>
